...
export default function Card(props) {
  ...
  let priceOptions= Object.keys(optionss);
  ...
  let finalPrice = qty * parseInt(optionss[size]);
  useEffect(() => {
  ...
  return (
    <>
      <div >
        ...
        >
          <img src={props.foodItem.img} style={{height:"200px",width:"300px"}}  className="card-img-top img-fluid" alt="..." />
          <div className="card-body" style={bstyle}>
